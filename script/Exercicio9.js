...
if (vlrCompra == vlrPagamento) {
    document.write("Não necessita de troco")
} else if (vlrCompra < vlrPagamento ) {
    document.write("Valor pago MENOR que o valor da compra.")
} else {
    ...
    document.write("Você deve passa " + nota100 + " notas de 100, " + nota10 + " notas de 10 e " + nota1 + " notas 1.")
}